...
public class HttpArrivalDataProvider extends AbstractHttpDataProvider {
    ...
    protected URL getURL() throws MalformedURLException {
        if (stop == null)throw new MalformedURLException();

        String urlString = "http://api.translink.ca/rttiapi/v1/stops/"+stop.getNumber()+"/estimates?apikey=AUTdIc0W3SywrqGn6OID";
